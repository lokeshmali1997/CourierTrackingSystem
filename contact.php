...
<div class="row" id="trackform" style="background-color: #f6fafd;margin-top:50px;" >
...
<div class="col-md-6">
  Name :
  <input type="text" class="txtbb" name=""/><br/><br/>
  Email :
  <input type="text" class="txtbb" name=""><br/><br/>
 Address :
  ...
  <input type="submit" class="btnsend" name="" value="SEND">
</div>
<div class="col-md-3">
</div>
  </div>

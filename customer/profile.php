			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li style="margin-top: 10px;"><a href="" class=""><i class="lnr lnr-printer"></i> <span>Print Invoice</span></a></li>
						<li style="margin-top: 10px;"><a href="Profle.php" class="active"><i class="lnr lnr-user"></i> <span>Profile</span></a></li>
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
						  <div class="row " >
                           ...
                           <div class="col-md-6">
                             <div class="form-group">
                              <label>Name</label>
                               <input type="text" ID="txtusername" class="form-control" name="txtupdatename" value=<?php echo $username; ?>  />
                          ...
                          <div class="col-md-6">
                           <div class="form-group">
                      <label>Number</label>
                       <input type="text" ID="txtrecnumber" class="form-control" name="txtupdatenumber" value=<?php echo $usernumber; ?> />
                           </div>
                          </div>
                      </div>
                       <div class="row " >
                           <div class="col-md-6">
                             <div class="form-group">
                              <label>Email</label>
                               <input type="text" ID="txtrecemail" class="form-control"  name="txtupdateemail" value=<?php echo $useremail; ?> />
                      ...
                      <label>Change Password</label>
                       <input type="Password" ID="txtaddbookname" class="form-control"  name="txtupdatepass" value=<?php echo $userpass; ?> />
                           </div>
                          </div>
                      </div>
                        <div class="row" style="margin-top: 20px;">
                      	...
                      	<div class="col-md-2">
                      		<input type="submit" id="btnnext" name="btnupadteuser" value="UPDATE" class="btn btn-success"/></div>
                      	<div class="col-md-5"></div>
